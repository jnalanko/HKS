...
# Plots
hks print-hierarchy --index index/CHM13-s63.hksb > preprint_results/hks_hierarchy_dump.txt
...
# Index sizes (used by the latex table below)
ls -l index/CHM13-s63.hksb index/CHM13-s63.hksf kraken_k*_m*/hash.k2d > preprint_results/index_sizes.txt
